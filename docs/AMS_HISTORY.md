...
| 18 | **Phase 5.0** | `2a2e0ad` | `e1f0fc6` | `None` | **Attendance Engine V2:** Database-driven department shift policies (shift_start_time, grace_minutes, shift_end_time); updated `AttendanceService` to resolve shift schedules dynamically; introduced `AttendanceOverrideController` and `AttendanceOverrideTest` features. |
| 19 | **Phase 5.3** | `30baa57` | None | `v1.2-phase-5.3` | **Attendance Administration V3:** Redesigned attendance logs console with Alpine.js tab workspaces (Roster, Override Management, Audit Trail). Unified bulk override workflow, weekly off Sunday engine, and optional classification overrides. |
| 20 | **Sprint 2.3.1** | `d89fb6f` | None | `None` | **Repository Stabilization & Documentation Sync:** Stabilized test assertions against V3 override logic (Sunday weekly off, timeline overrides). |
| 21 | **Phase 5.6** | `716ae7f` | None | `v1.2-phase-5.6` | **Custom Shifts & Birthday Credits Engine:** Configured dynamic shift parameters (Healthcare override 10:00-18:00 with 5m grace). Setup reusable birthday leave credits sync, auto-approvals, leap Feb 29 shifts, and expiration rules. |
| 22 | **Phase 5.7** | `9971257` | None | `v1.2-phase-5.7` | **Bulk Overrides & Conflict Handling:** Implemented bulk overrides for user/department/all across single/range/multiple dates. Enforced database transaction locking and conflict options (`skip`, `replace`, `cancel`). |
| 23 | **Phase 5.8** | `HEAD` | None | `v1.2-phase-5.8` | **Walnut-Ivory Design Overhaul & 12-Hour Clocks:** Redesigned stylesheet baseline to premium tactile Walnut/Ivory/Brass aesthetic. Converted clocks/timestamps to 12-hour AM/PM format. |
...
### Phase 5.0 (Sprint 2.0) — Attendance Engine V2
* **Business Problem:** Shift hours and grace periods were hardcoded in configurations globally, failing to support department-specific policies (e.g. Healthcare vs Engineering shifts). Administrative overrides on clock statuses and classifications lacked database auditing.
* **Details:** Implemented database-driven shift schedules on the `departments` table. Added audit and automatic classification fields to the `attendances` table. Created `AttendanceOverrideController` and updated `AttendanceService` to resolve shift policies dynamically.
* **Files:** [AttendanceOverrideController.php](file:///c:/Users/Lenovo/AMS-V1/app/Http/Controllers/AttendanceOverrideController.php) [NEW], [AttendanceService.php](file:///c:/Users/Lenovo/AMS-V1/app/Services/AttendanceService.php) [MODIFY], [Attendance.php](file:///c:/Users/Lenovo/AMS-V1/app/Models/Attendance.php) [MODIFY].

### Phase 5.3 (Sprint 2.3) — Attendance Administration V3
* **Business Problem:** Roster management, override listings, and audit timeline views were separate, creating a complicated user flow. Also, Sundays were falsely marked as absent instead of weekly off, and multi-employee bulk selections were cramped in small modal frames.
* **Details:** Consolidated all administration views into a single logs page split into Alpine-driven tabs (Roster, Overrides, Audit Timeline). Added support for bulk overrides, department-level checks, a Sunday weekly off status engine, and optional classification locks.
* **Files:** [attendance-logs.blade.php](file:///c:/Users/Lenovo/AMS-V1/resources/views/admin/attendance-logs.blade.php) [MODIFY], [AttendanceAuditController.php](file:///c:/Users/Lenovo/AMS-V1/app/Http/Controllers/AttendanceAuditController.php) [MODIFY], [AttendanceOverrideController.php](file:///c:/Users/Lenovo/AMS-V1/app/Http/Controllers/AttendanceOverrideController.php) [MODIFY].

### Sprint 2.3.1 — Repository Stabilization & Documentation Synchronization
* **Business Problem:** Divergences between test assertions and V3 override logic caused test failures. Documentation also diverged from current tag versions and metrics.
* **Details:** Aligned test assertions for Sunday status to check for `'weekly_off'`. Shifted override test dates to a weekday to validate standard absent calculations, and verified that `groupedOverrides` are passed to views. Audited and synchronized the entire `/docs` directory.
* **Files:** [WorkingDaysTest.php](file:///c:/Users/Lenovo/AMS-V1/tests/Feature/WorkingDaysTest.php) [MODIFY], [AttendanceOverrideTest.php](file:///c:/Users/Lenovo/AMS-V1/tests/Feature/AttendanceOverrideTest.php) [MODIFY], [CURRENT_STATE.md](file:///c:/Users/Lenovo/AMS-V1/docs/CURRENT_STATE.md) [MODIFY], [HANDOVER.md](file:///c:/Users/Lenovo/AMS-V1/docs/HANDOVER.md) [MODIFY], [DECISION_LOG.md](file:///c:/Users/Lenovo/AMS-V1/docs/DECISION_LOG.md) [MODIFY], [AMS_HISTORY.md](file:///c:/Users/Lenovo/AMS-V1/docs/AMS_HISTORY.md) [MODIFY].

### Phase 5.6 — Custom Shifts & Birthday Credits Engine
* **Business Problem:** Department shift configurations were static, healthcare timing overrides lacked config mapping, and birthday leave requests lacked automated credit token sync and expiry loops.
* **Details:** Configured dynamic department shifts (Healthcare override 10:00-18:00 with 5m grace). Created `LeaveCredit` database table and sync engine in `User.php` (Feb 29 birthday offsets, pre-joining limits, 1-year expiry). Setup auto-approvals and zero-ledger deductions for complimentary leaves in `LeaveBalanceService`.
* **Files:** `2026_06_24_154000_create_leave_credits_table.php` [NEW], [LeaveCredit.php](file:///c:/Users/Lenovo/AMS-V1/app/Models/LeaveCredit.php) [NEW], [AttendanceTimingResolver.php](file:///c:/Users/Lenovo/AMS-V1/app/Services/AttendanceTimingResolver.php) [MODIFY], [User.php](file:///c:/Users/Lenovo/AMS-V1/app/Models/User.php) [MODIFY], [LeaveBalanceService.php](file:///c:/Users/Lenovo/AMS-V1/app/Services/LeaveBalanceService.php) [MODIFY].

### Phase 5.7 — Bulk Overrides & Conflict Handling
* **Business Problem:** Admins required a workspace to commit overrides for multiple employees/departments over date ranges. Prior manual overrides and active leaves created conflicts during updates.
* **Details:** Built bulk overrides preview and commit services in `AttendanceService` utilizing pessimistic locks (`lockForUpdate`). Implemented conflict options (`skip`, `replace`, `cancel`) and filters (skip leaves, skip overrides, weekend exclusions).
* **Files:** [AttendanceOverrideController.php](file:///c:/Users/Lenovo/AMS-V1/app/Http/Controllers/AttendanceOverrideController.php) [MODIFY], [AttendanceService.php](file:///c:/Users/Lenovo/AMS-V1/app/Services/AttendanceService.php) [MODIFY], [BulkAttendanceOverrideTest.php](file:///c:/Users/Lenovo/AMS-V1/tests/Feature/BulkAttendanceOverrideTest.php) [NEW].

### Phase 5.8 — Walnut-Ivory Visual Design Overhaul & 12-Hour Clocks
* **Business Problem:** Laravel default Breeze layouts looked generic, and clocks/timestamps were in military format.
* **Details:** Redesigned stylesheet baseline to premium tactile Walnut/Ivory/Brass aesthetic. Rebuilt datatables, metrics cards, form inputs, and buttons. Converted user-facing times to 12-hour AM/PM format.
* **Files:** [app.css](file:///c:/Users/Lenovo/AMS-V1/resources/css/app.css) [MODIFY], [ledger-table.blade.php](file:///c:/Users/Lenovo/AMS-V1/resources/views/components/ledger-table.blade.php) [MODIFY], [auth-layout.blade.php](file:///c:/Users/Lenovo/AMS-V1/resources/views/components/auth-layout.blade.php) [MODIFY], [app.blade.php](file:///c:/Users/Lenovo/AMS-V1/resources/views/layouts/app.blade.php) [MODIFY], [login.blade.php](file:///c:/Users/Lenovo/AMS-V1/resources/views/auth/login.blade.php) [MODIFY].
