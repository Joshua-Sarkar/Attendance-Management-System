        ...
        @if(auth()->user()->role === 'admin' && isset($companyMetrics))
            <div class="space-y-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                    ...
                    <div class="glass-panel p-6 rounded-lg border border-outline-variant/30 flex items-center justify-between">
                        <div>
                            <span class="text-on-surface-variant text-sm font-medium">Correction Requests</span>
                            <h3 class="text-3xl font-bold text-amber-600 dark:text-amber-400 mt-1">{{ $companyMetrics['pending_corrections'] }}</h3>
                        </div>
                        <div class="w-12 h-12 rounded-full bg-amber-100 dark:bg-amber-900/20 flex items-center justify-center text-amber-700">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
