                ...
                <form method="POST" action="{{ route('departments.update', $department) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea
                            ...
                            name="description"
                            rows="4"
                            class="mt-1 block w-full bg-surface-raised border border-hairline text-vellum focus:border-brass/50 focus:ring focus:ring-brass/30 focus:ring-1 rounded-md shadow-sm px-3 py-2">{{ old('description', $department->description) }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-burgundy">{{ $message }}</p>
                        @enderror
                    </div>
